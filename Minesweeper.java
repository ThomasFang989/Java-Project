//All the library imports are over here
...
////Set up the basic frame and button elements
public class Minesweeper implements ActionListener{
	...
	//Clear all the zeros on the graph
...
//Do the corresponding action when the player click one button on the graph
