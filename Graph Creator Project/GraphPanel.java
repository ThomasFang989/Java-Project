...
//Get the things in Jpanel when needed
public class GraphPanel extends JPanel {
	...
	//Two important arraylist created here
	...
	//Set the node shape to circle, et the color of the node to red when clicked, then change back to black. And draw the name of the edge at its half point
